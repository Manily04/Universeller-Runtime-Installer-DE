...
color 4
echo "Bitte lösche keine Dateien in diesem Ordner bis das Setup vollständig beendet ist". >"%userprofile%\Downloads\URI\!Bitte nicht löschen!.txt"
cls
...
echo "Visual C++ Download erfolgreich heruntergeladen" >c:\users\public\downloads\VC\VCdownload.bin
exit